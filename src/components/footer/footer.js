        ...
        <div className="footer-wrap border border-primary">
            <div className="row container-fluid">
                ...
                <div className="col-md-4" id="footer-social-div">
                    ...
                    <div className="row d-flex justify-content-center">
                        <a className="social-icons" target='_blank' href="https://www.facebook.com/shahfaisallive"><i className="social-icon-footer fab fa-facebook"></i></a>
                        <a className="social-icons" target='_blank' href="https://twitter.com/shahfaisallive"><i className="social-icon-footer fab fa-twitter-square"></i></a>
                        <a className="social-icons" target='_blank' href="https://instagram.com/travelogicpk"><i className="social-icon-footer fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
