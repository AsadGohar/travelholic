        ...
        <div className="container SignUp-wrap">
					...
					<div className="container ">
						...
						<div className="float-left" >
							...
							<div className="p-3" style={{maxWidth:"400px",backgroundColor:"#1a936f"}}>
								<div className="d-flex justify-content-center mt-2">
									<img src={"/images/logo.png"} alt="" style={{maxWidth:"45px"}} className="img-fluid"></img>
									<span className="ml-2" style={{fontSize:"30px",fontFamily:"cursive",color:'white'}}>Travelholic</span>
								</div>
								<p style={{color:'white',marginTop:"20px"} }>Travelholics is one of the leading travelguide system and tour operating company in Pakistan. We aim to provide best guidance for travel enthusiastics across Pakistan.
								Travelholics is one of the leading travelguide system and tour operating company in Pakistan. We aim to provide best guidance for travel enthusiastics across Pakistan Travelholics is one of the leading travelguide system and tour operating company in Pakistan. We aim to provide best guidance for travel enthusiastics across Pakistan</p>
